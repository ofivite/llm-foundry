...
if __name__ == '__main__':
    ...
    LR_VALS = [0.00048828, 0.00069053, 0.00097656, 0.00138107, 0.00195312,
    ...
    cfg.run_name = f'lr-{array_id}-std-{cfg.model._mup_config._init_std}-warmup-{cfg.scheduler.t_warmup}-dur-{cfg.max_duration}-job-{os.getenv("SLURM_JOB_ID", 0)}' # -std-fixed-horizon-fixed
